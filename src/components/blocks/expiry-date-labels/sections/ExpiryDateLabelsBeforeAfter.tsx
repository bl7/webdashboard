...
import { AlertTriangle, CheckCircle, Clock, Zap, Calendar, Shield } from "lucide-react"
import { motion } from "framer-motion"

export const ExpiryDateLabelsBeforeAfter = () => (
    ...
    <div className="mx-auto max-w-5xl">
      ...
      >
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">
          Watch how InstaLabel transforms expiry date labeling from a time-consuming manual process
        ...
        <div className="mx-auto max-w-4xl rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-12">
          <div className="text-center">
            ...
            <h3 className="mb-2 text-xl font-bold text-gray-900">
              Real Expiry Date Label Examples
            </h3>
            <p className="text-gray-600">
              [Image Placeholder: Show real expiry date labels printed with InstaLabel software vs.
              manual handwritten examples]
            </p>
            <p className="mt-2 text-sm text-gray-500">
              Professional printed labels with accurate expiry dates vs. handwritten labels with
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        >
          ...
          {/* Visual: Manual Expiry Date Label */}
            ...
            <div className="mb-3 text-center">
              <div className="mx-auto h-24 w-32 rounded border-2 border-dashed border-red-300 bg-red-50 p-2">
                <div className="text-center text-xs text-red-600">
                  ...
                  <div className="text-red-500">Prepared: 15 Jan</div>
                  <div className="text-red-500">Use By: ???</div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-red-600">Staff manually calculating expiry dates</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <AlertTriangle className="mt-1 h-4 w-4 text-red-600" />
              <div>
                <div className="font-semibold text-red-800">45% compliance errors</div>
                <div className="text-sm text-red-600">Missing allergens, incorrect dates</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <Calendar className="mt-1 h-4 w-4 text-red-600" />
              <div>
                <div className="font-semibold text-red-800">Food safety risks</div>
                <div className="text-sm text-red-600">Incorrect expiry dates can cause illness</div>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          {/* Visual: Professional Expiry Date Label */}
          <div className="mb-6 rounded-lg bg-white p-4 shadow-sm">
            <div className="mb-3 text-center">
      ...
      >
        <div className="rounded-lg bg-red-50 p-6 text-center">
          ...
          <div className="mt-1 text-xs text-red-600">Staff calculating dates manually</div>
        </div>
      ...
      >
        <p className="text-lg font-semibold text-gray-700">
          <span className="font-bold text-purple-700">
            Ready to transform your expiry date labeling?
          </span>
