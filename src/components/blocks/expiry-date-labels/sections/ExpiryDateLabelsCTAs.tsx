...
export const ExpiryDateLabelsCTAs = () => (
      ...
      >
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-6">
          ...
          <p className="mb-4 text-gray-600">
            Get our "Complete Guide to Expiry Date Labeling" with compliance requirements, best
            practices, and InstaLabel implementation strategies.
          </p>
          <Button variant="outline" className="w-full" asChild>
            <Link href="/blog/expiry-date-labeling-complete-guide">Download Free Guide</Link>
          </Button>
        </div>
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-6">
          ...
          <p className="mb-4 text-gray-600">
            Experience InstaLabel's mobile-first design for expiry date labeling. Download our
            Android app to see how easy it can be on mobile devices.
          </p>
          <Button variant="outline" className="w-full" asChild>
