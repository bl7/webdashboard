...
export const History = () => {
  return (
    <section className="py-8 sm:py-16">
      <div className="container px-2 sm:px-4 pb-12 sm:pb-24 md:px-12 lg:px-16">
        <div className="h-48 sm:h-96 w-full overflow-hidden rounded-lg">
          <Image src={care} alt="Chef in busy kitchen" className="h-full w-full object-cover" />
        </div>
        <h1 className="mt-8 sm:mt-12 text-2xl sm:text-3xl leading-tight tracking-tight sm:text-4xl">
          From Kitchen Chaos to Labeling Clarity
        </h1>
        <p className="mt-6 sm:mt-8 text-sm sm:text-base leading-relaxed tracking-wide">
        ...
        <p className="mt-3 sm:mt-4 text-sm sm:text-base leading-relaxed tracking-wide">
