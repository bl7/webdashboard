        ...
        >
          <div className="mx-auto max-w-4xl rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-12">
            <div className="text-center">
              ...
              <h3 className="mb-2 text-xl font-bold text-gray-900">Real Kitchen Label Examples</h3>
              <p className="text-gray-600">
                [Image Placeholder: Show real examples of prep labels, cook labels, and PPDS labels
                in action]
              </p>
              <p className="mt-2 text-sm text-gray-500">
                Visual examples of how different label types work in real kitchen environments
              </p>
            </div>
          </div>
        </motion.div>
