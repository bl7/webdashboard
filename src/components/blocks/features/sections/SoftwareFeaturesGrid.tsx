...
export const SoftwareFeaturesGrid = () => (
  <section className="bg-white py-20">
    <div className="mx-auto flex max-w-5xl flex-col items-center gap-12 px-4 md:flex-row lg:px-0">
      {/* Features List */}
      <div className="flex-1 space-y-6">
        ...
        <p className="mb-8 text-lg text-gray-600">
          Our software is built for hospitality—compliant, fast, and easy for any staff member to
          use.
        </p>
