...
export const PrintBridgeHero = () => {
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden px-4 sm:px-6 md:px-12 lg:px-16 bg-gradient-to-br from-purple-50 via-white to-pink-50 py-16 mt-24 sm:mt-32 md:mt-16">
      {/* Background elements */}
      ...
      <div className="container relative z-10 mx-auto flex flex-col items-center justify-between gap-8 md:flex-row">
        {/* Visual Representation */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1, delay: 0.3 }}
          className="w-full max-w-md mb-8 md:mb-0 z-20"
        >
        ...
        <motion.div
          ...
          className="w-full max-w-xl space-y-6 text-center md:text-left z-30"
        >
