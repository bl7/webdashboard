...
import { AlertTriangle, Droplets, Clock, FileText, Shield, Calendar } from "lucide-react"
import { motion } from "framer-motion"

export const DissolvableKitchenLabelsProblem = () => (
  <section className="relative w-full bg-white px-4 py-16 sm:px-6 md:px-12 lg:px-16">
    <div className="mx-auto flex max-w-5xl flex-col items-center gap-12 md:flex-row">
      {/* Visual: Dissolvable label problems illustration */}
      <motion.div
      ...
      >
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-6 shadow-lg">
          ...
          <div className="space-y-3 text-center">
            <div className="text-sm font-medium text-gray-700">Dissolvable Label Chaos</div>
      ...
      >
        <div className="mb-1 inline-flex items-center rounded-full bg-red-100 px-3 py-1 text-xs font-semibold text-red-700 ring-1 ring-red-200">
          ...
          Dissolvable Label Problems
        </div>
        <h3 className="text-3xl font-black leading-tight tracking-tight text-gray-900 sm:text-4xl">
          Manual Dissolvable Label Creation is Error-Prone & Time-Consuming
        </h3>
        <ul className="mx-auto max-w-md list-disc space-y-2 pl-6 text-base text-gray-700 md:mx-0">
          <li>Staff spend 2-3 minutes creating each dissolvable label manually</li>
          <li>Manual typing leads to illegible text and compliance violations</li>
          <li>Ink smudging and fading issues with handwritten dissolvable labels</li>
          <li>Natasha's Law compliance requires perfect allergen and ingredient formatting</li>
          <li>No audit trail for food safety inspections and EHO visits</li>
          <li>Food waste increases due to incorrect or illegible label information</li>
