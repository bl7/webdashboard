...
import { ArrowRight, Calendar, Package, Users, AlertTriangle } from "lucide-react"
import React from "react"
import { motion } from "framer-motion"
import Link from "next/link"

export const PrepLabelsHero = () => {
  return (
        ...
        >
          ...
          >
            <h1 className="font-accent text-4xl font-extrabold leading-tight tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
              <span className="text-mkt-teal">Prep Labels</span>
              <br className="hidden md:block" />
              <span>That Keep Kitchens Running Smooth</span>
            </h1>
          </motion.div>
          ...
          >
            <p className="max-w-xl text-base text-gray-600 sm:text-lg md:text-xl">
              Automated prep labels with expiry, allergens, and batch details — no handwriting
              required.
            </p>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <div className="flex items-center justify-center gap-2 text-sm text-gray-600 md:justify-start">
                <Calendar className="h-4 w-4 text-mkt-teal" />
          ...
          <div className="relative">
            ...
            <div className="flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white shadow-lg md:flex-row">
              ...
              <div className="flex flex-1 flex-col justify-between border-b border-gray-100 bg-gray-50 p-4 md:border-b-0 md:border-r">
                <div>
                  <div className="mb-2 flex items-center gap-2">
                    ...
                    <span className="ml-2 text-xs text-gray-500">Prep Station</span>
                  </div>
                  ...
                  <div className="mb-2 text-xs text-gray-400">
                    Handwritten: <span className="text-gray-600">Illegible</span>
                  </div>
                </div>
                <div className="mt-2 text-[10px] text-red-400">
                  No allergens? No batch code? EHO violations!
                </div>
              </div>
              ...
              <div className="flex flex-1 flex-col items-center justify-center bg-mkt-canvas p-4">
                ...
                <div className="mb-1 text-lg font-bold text-gray-800">Mixed Vegetables</div>
                <div className="text-xs text-gray-500">Expires: MON 01 Jul 2024</div>
                <div className="text-xs text-gray-500">Contains: CELERY</div>
              </div>
            </div>
          </div>
        </motion.div>
