...
import { AlertTriangle, CheckCircle, Clock, Zap, Shield, FileText } from "lucide-react"
import { motion } from "framer-motion"

export const AllergenComplianceBeforeAfter = () => (
    ...
    <div className="mx-auto max-w-5xl">
      ...
      >
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">
          Watch how InstaLabel transforms allergen labeling from a time-consuming manual process
      ...
      >
        <div className="mx-auto max-w-4xl rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-12">
          <div className="text-center">
            ...
            <h3 className="mb-2 text-xl font-bold text-gray-900">Real Allergen Label Examples</h3>
            <p className="text-gray-600">
              [Image Placeholder: Show real allergen labels printed with InstaLabel software vs.
              manual handwritten examples]
            </p>
            <p className="mt-2 text-sm text-gray-500">
              Professional printed labels with complete allergen information vs. handwritten labels
      ...
      <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="mb-3 text-center">
              <div className="mx-auto h-24 w-32 rounded border-2 border-dashed border-red-300 bg-red-50 p-2">
                <div className="text-center text-xs text-red-600">
                  ...
                  <div className="text-red-500">Natasha's Law: ???</div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-red-600">Staff manually checking 14 allergens</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
        ...
        >
          ...
          {/* Visual: Professional Allergen Label */}
          <div className="mb-6 rounded-lg bg-white p-4 shadow-sm">
            <div className="mb-3 text-center">
