...
export const Hero = () => {
  return (
    <section className="relative flex flex-col md:flex-row min-h-screen items-center overflow-hidden px-2 sm:px-4 md:px-12 lg:px-16 bg-gradient-to-br from-purple-50 via-white to-pink-50 py-8 sm:py-12 md:py-16 mt-24 sm:mt-32 md:mt-16 gap-8 md:gap-16">
