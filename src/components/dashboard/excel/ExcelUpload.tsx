...
const ExcelUpload: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 transition-all duration-1000 ease-in-out">
        {!hasUploaded ? (
            ...
            <div className="w-full max-w-2xl transform transition-all duration-700 ease-out">
              <div className="hover:shadow-3xl overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-2xl transition-shadow duration-300">
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-center">
                  ...
                  <p className="text-lg text-blue-100">2 clicks and your entire menu is imported</p>
                </div>

                <div className="p-8">
                  <div className="text-center">
                    <div className="border-3 group transform rounded-2xl border-dashed border-gray-300 p-12 transition-all duration-300 hover:scale-[1.02] hover:border-blue-400">
                    ...
                    {uploadError && (
                      <div className="animate-fade-in mt-6 flex items-start space-x-3 rounded-xl border border-red-200 bg-red-50 p-4">
                  ...
                  {processing && (
                    <div className="animate-fade-in mt-6 rounded-xl border border-blue-200 bg-blue-50 p-4">
          ...
          <div className="animate-fade-in grid h-screen grid-cols-3 gap-6 p-6">
            {/* Left Panel - Upload Controls (1/3) */}
            <div className="flex transform animate-[slideInLeft_0.8s_ease-out] flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg transition-all duration-700 ease-out hover:shadow-xl">
              ...
              <div className="flex flex-1 flex-col space-y-6 p-6">
                ...
                {processing && (
                  <div className="animate-fade-in rounded-xl border border-blue-200 bg-blue-50 p-4">
                    <div className="flex items-center space-x-3">
                      <div className="h-5 w-5 animate-spin rounded-full border-2 border-blue-600 border-t-transparent"></div>
                ...
                {importResult && (
                  <div className="flex-1 animate-[slideInLeft_0.6s_ease-out_0.6s_both] overflow-hidden rounded-xl border border-gray-200 bg-gray-50 p-4">
            ...
            <div className="col-span-2 flex transform animate-[slideInRight_0.8s_ease-out] flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg transition-all duration-700 ease-out hover:shadow-xl">
              ...
              <div className="flex-1 animate-[slideInRight_0.6s_ease-out_0.4s_both] overflow-auto bg-white p-6">
                <DataTable data={data} />
              </div>
            </div>
          </div>
