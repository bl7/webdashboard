        ...
        <div className="flex w-full">
          <div className="w-full">
            ...
            <h3 className="text-lg leading-relaxed">
              ...
              <a href="mailto:support@InstaLabel.com">please get in touch.</a>
            </h3>
          </div>
        </div>
        <article>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to InstaLabel, the software program provided by
                the Company.
              </p>
            </li>
            <li>
              <p>
                ...
                InstaLabel Pvt. Ltd., Kathmandu, Nepal.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to InstaLabel, accessible from{" "}
                <a
                  href="https://www.InstaLabel.com/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://www.InstaLabel.com/
                </a>
              </p>
            </li>
            <li>
          ...
          <p>
            We understand that fostering a safe and secure learning environment for children of all
            ages is paramount. We are committed to protecting the privacy of all our users, with a
            particular focus on our young learners under the age of 13. Here&apos;s how we ensure a
            positive and secure learning experience for them:
          </p>
          <p>
            <strong>Prioritizing Parental Consent:</strong> We recognize the importance of parental
            involvement in a child&apos;s online learning journey. This is why we require verifiable
            parental consent before collecting any personal information from children under 13. This
            ensures that parents or guardians have control over the data their child shares with our
            platform.
          </p>
          <p>
            <strong>Limited Data Collection:</strong> We believe in collecting only the minimum
            amount of information necessary to provide a safe and personalized learning experience
            for each child. This may include usernames, learning progress data, and non-identifiable
            learning analytics. These details help us personalize the learning experience for each
            child while safeguarding their privacy.
          </p>
          <p>
            <strong>Security First:</strong> We prioritize the security of all data collected from
            our users. Any information collected from young learners is stored securely on our
            servers and protected by industry-standard security measures. This ensures that their
            data remains safe and protected from unauthorized access.
          </p>
          <p>
            <strong>Empowering Parents/Guardians:</strong> We believe in empowering parents or
            guardians to be actively involved in their child&apos;s online learning journey. This is
            why we offer them access to their child&apos;s account and data. This allows parents to
            review the information collected, manage settings, and even request data deletion if
            necessary.
          </p>
          <p>
            <strong>Transparency:</strong> We believe in clear and transparent communication. We
            provide easily understandable information about our privacy practices, tailored both for
            young learners and their parents or guardians. This ensures everyone involved
            understands how we handle data and how to exercise their privacy rights.
          </p>
          <p>
          ...
          <p>
            We welcome any questions you may have about our Children&apos;s Privacy Policy. Please
          ...
          <ul>
            <li>
              <p>By email: support@InstaLabel.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="https://InstaLabel.com/support"
                  rel="external nofollow noopener"
                  target="_blank"
                >
